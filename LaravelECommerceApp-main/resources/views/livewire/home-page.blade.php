...
{{-- HERO SECTION START --}}
  ...
  <div class="w-full h-screen bg-gradient-to-r from-pink-200 to-pink-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    <!-- Grid -->
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-pink-500">UHDWonders</span></h1>
        ...
        <div class="mt-7 grid gap-3 w-full sm:inline-flex">
          <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-pink-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/register">
            Get started
  ...
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      <div class="relative flex flex-col items-center">
        <h1 class="text-5xl font-bold dark:text-gray-200"> Browse Popular<span class="text-pink-500"> Brands
          </span> </h1>
        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
          ...
          <div class="flex-1 h-2 bg-pink-600">
          </div>
        </div>
      </div>
      <p class="mb-12 text-base text-center text-gray-500">
      Browse our collection of popular products featuring the latest gadgets, stylish apparel, and everyday essentials. Discover top-rated items trusted by customers for quality, performance, and unbeatable value. Shop now!
      </p>
    </div>
  </div>
...
<div class="bg-orange-200 py-20">
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      <div class="relative flex flex-col items-center">
        <h1 class="text-5xl font-bold dark:text-gray-200"> Browse <span class="text-pink-500"> Categories
          </span> </h1>
        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
          <div class="flex-1 h-2 bg-blue-200">
          </div>
      ...
      <div class="p-4 md:p-5">
        <div class="flex justify-between items-center">
          <div class="flex items-center">
            ...
            <div class="ms-3">
              <h3 class="group-hover:text-pink-500 font-semibold text-gray-800 dark:group-hover:text-gray-400 dark:text-gray-200">
                {{$category->name}}
              </h3>
            </div>
          </div>
...
<section class="py-14 font-poppins dark:bg-gray-800">
  <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        <div class="relative flex flex-col items-center">
          <h1 class="text-5xl font-bold dark:text-gray-200"> Customer <span class="text-pink-500"> Reviews
            </span> </h1>
          <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
            <div class="flex-1 h-2 bg-blue-200">
            </div>
        ...
        <p class="mb-12 text-base text-center text-gray-500">
        "Fantastic quality and fast shipping! The product exceeded my expectations. It looks amazing and works perfectly. I'm really satisfied with this purchase and will definitely recommend it to friends."
        </p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
      <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
        ...
        "Great experience overall. The product arrived on time, well-packaged, and exactly as described. Customer service was quick to respond to my query. Very happy with the value for money."
        </p>
        <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
          <div class="flex px-6 mb-2 md:mb-0">
            <ul class="flex items-center justify-start mr-4">
              <li>
                <a href="#">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-4 mr-1 text-pink-500 dark:text-blue-400 bi bi-star-fill" viewBox="0 0 16 16">
      ...
      <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
        ...
        <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
        "I loved the sleek design and premium feel. Everything worked out of the box. Setup was easy and delivery was faster than expected. Highly recommend this to anyone considering a purchase."
      ...
      <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
        ...
        <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
        "The item is just perfect. It’s functional, stylish, and affordable. There was a minor delay in delivery, but support handled it well. Would definitely shop from here again soon."
